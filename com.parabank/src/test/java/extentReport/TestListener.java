   ...
   public synchronized void onTestFailure(ITestResult result) {
    ...
    private String captureScreenshot(String methodName) {
        try {
            ...
            String rootPath="/eclipse-workspace/com.parabank";
            String screenshotPath = System.getProperty("user.home") +rootPath+ "/TestReport/Screenshots/" + methodName +timeStamp+ ".png";
